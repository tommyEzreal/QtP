...
class ModelArguments:
    ...
    use_auth_token: Optional[bool] = field(
        default=True, metadata={"help": "Enables using Huggingface auth token from Git Credentials."}
    )
...
class TrainingArguments(transformers.Seq2SeqTrainingArguments):
    ...
    gradient_accumulation_steps: int = field(
        default=1, metadata={"help": "How many gradients to accumulate before to perform an optimizer step"}
    )
    ################################################################################################################
    bf16: bool = field(
    ...
    save_total_limit: int = field(
        default=1, metadata={"help": "How many checkpoints to save before the oldest is overwritten"}
    )
...
def local_dataset(dataset_name):
    if dataset_name.endswith(".json") or dataset_name.endswith(".jsonl"):
        full_dataset = Dataset.from_json(path_or_paths=dataset_name, field='data')
